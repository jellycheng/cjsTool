...
/*
  ...
  +----------------------------------------------------------------------+
*/
#通过fsockopen方式来链接memcache的，没有使用memcache和memcached扩展
...
$MEMCACHE_SERVERS[] = 'dev-mem.a.pa.com:11211'; // add more as an array
//配置多台，增加数组即可,如：$MEMCACHE_SERVERS[] = 'memcache主机:端口';
$MEMCACHE_SERVERS[] = 'st-mem.a.pa.com:11211'; // add more as an array
...
<div class="head">
	<h1 class="memcache">
		<span class="logo"><a href="http://pecl.php.net/package/memcache" target="_blank">memcache</a></span>
		<span class="nameinfo">memcache.php by <a href="http://livebookmark.net" target="_blank">Harun Yayli</a></span>
	</h1>
	<hr class="memcache">
</div>
<div class=content>
